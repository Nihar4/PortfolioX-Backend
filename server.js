...
//     setInterval(fetchDataAndMerge, 60000);
...
// nodeCron.schedule("0 58 */1 * * *", async () => {
//     try {
//         // console.log(part1);
//         await axios.post('http://localhost:4000/api/v1/createallstocks1');
...
// nodeCron.schedule("0 1 */1 * * *", async () => {
//     try {
//         // console.log(part1);
//         await axios.post('http://localhost:4000/api/v1/createallstocks2');
